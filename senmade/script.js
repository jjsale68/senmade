...
function showMemoryNote() {
    const notes = [
        'Happy Birthday, Kofoworola! E.K Fashion Fusion’s gonna slay!',
        'Your dancing makes June 5 the hottest vibe!',
        'Ziba Beach with you? My heart’s all in, love!'
    ];
...
if (countdownElement) {
    const countdown = setInterval(() => {
        ...
        if (distance < 0) {
            ...
            countdownElement.textContent = 'Happy Birthday, Kofoworola! Ziba Time! ??';
        }
    }, 1000);
}
